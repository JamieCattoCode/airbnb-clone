  ...
  return (
    <header className="flex justify-between">
      ...
      <div className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md">
        ...
        <Link to={user ? '/profile' : '/login'} className="flex gap-2 items-center">
          <div className="border border-gray-500 rounded-full bg-gray-500 text-white p-1/2 overflow-hidden">
